...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        private static readonly Regex rexQualifiedName = new Regex(@"(,[^,]*){3}$");
        private static readonly string keyTypeInfo = "@typeInfo";
        #endregion
        ...
        {
            return t.GetInterface ("System.Collections.IDictionary") != null;
        }
                    ...
                    if (t_data.Properties.ContainsKey (property)) {
                        ...
                        if (! t_data.IsDictionary) {
							...
							if (reader.Token == JsonToken.ObjectStart) {						
								while (reader.Token != JsonToken.ObjectEnd) reader.Read();
							}
                            continue;
                        }
...
//                                    "property '{1}'", inst_type, property));
        ...
        private static Type currentMemberType = null;
        ...
        public static T ToObject<T> (string json, bool usingTypeInfo = false)
        {
            JsonReader reader = new JsonReader (json);
            return (T) ReadValue (typeof (T), reader, usingTypeInfo);
        }
